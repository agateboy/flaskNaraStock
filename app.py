...
#     # Ambil data terbaru 1.5 tahun terakhir kira2 utk amankan window
#     start_date = '2015-01-01'  # Mulai dari awal data yang tersedia
#     end_date = datetime.today().strftime('%Y-%m-%d')

#     # Ambil data dari yfinance
#     datap = yf.download(symbol, start=start_date, end=end_date)
#     if datap.empty:
#         return jsonify({'error': 'Data tidak tersedia dari Yahoo Finance'}), 500

#     datap = datap[['Close', 'High', 'Low', 'Open', 'Volume']]
#     datap.columns = ['Close', 'High', 'Low', 'Open', 'Volume']

#     # Drop volume jika semua 0
#     if datap['Volume'].nunique() == 1 and datap['Volume'].iloc[0] == 0:
